...
class PollDao {
    ...
    findPollsByAuthor(usernameIn) {
        return __awaiter(this, void 0, void 0, function* () {
            const pollArr = yield PollModel_1.default.find({ author: { username: usernameIn } }, {});
        });
    }
    /**
    ...
    updateVote(pollIn) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield PollModel_1.default.findByIdAndUpdate(targetPollID, { optionCount: updatedVoteCountArr });
            return yield this.findPollById(targetPollID);
        });
    }
}
